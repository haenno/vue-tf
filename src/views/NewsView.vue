<template>
  ...
  <ButtonDefaultStyle :button="{ text: 'Get news' }" class="w-full" @click="newsStore.get_latest_news()" />
  <ButtonDefaultStyle :button="{ text: 'Create more news' }" class="w-full" @click="newsStore.create_fake_news()" />
  ...
  <div id="news_box"
    ...
    <div v-for="(id) in      newsStore.getNewsArray     " :key="newsStore.news_array" :class="`news-index-${id.id}`">
