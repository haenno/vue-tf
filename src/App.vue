...
<template>
  <header>
    <nav
      class="fixed top-0 z-50 w-full border-b bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700"
    >
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            <button
              ...
              type="button"
              class="inline-flex items-center p-2 text-sm rounded-lg sm:hidden focus:outline-none focus:ring-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:ring-gray-200 dark:focus:ring-gray-600"
            >
          ...
          <div class="flex items-center">
            <div class="flex items-center ml-3">
              ...
              <div
                class="flex text-sm rounded-full focus:ring-4 me-2 bg-gray-200 dark:bg-gray-700 focus:ring-gray-300 dark:focus:ring-gray-600"
              >
                <button
                  id="theme-toggle"
                  type="button"
              ...
              >
                <div class="px-4 py-3" role="none">
                  <p class="text-sm text-gray-900 dark:text-white" role="none">
                    Henning 'haenno' Beier
                  </p>
                  <p
                    class="text-sm font-medium text-gray-900 truncate dark:text-gray-300"
                    role="none"
                  >
                    <a href="mailto:haenno@web.de">haenno@web.de</a>
                  </p>
                </div>
