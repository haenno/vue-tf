          ...
          <ul class="space-y-2 font-medium">
            <li>
              <RouterLink
                ...
                data-drawer-hide="nav-and-sidebar" data-drawer-target="nav-and-sidebar" to="/">
            ...
            <li>
              <RouterLink
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                data-drawer-hide="nav-and-sidebar" data-drawer-target="nav-and-sidebar" to="/about">
            ...
            <li>
              <RouterLink
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                data-drawer-hide="nav-and-sidebar" data-drawer-target="nav-and-sidebar" to="/login">
            ...
            <li>
              <RouterLink
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                data-drawer-hide="nav-and-sidebar" data-drawer-target="nav-and-sidebar" to="/tasks">
            ...
            <li>
              <RouterLink
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                data-drawer-hide="nav-and-sidebar" data-drawer-target="nav-and-sidebar" to="/inbox">
            ...
            <li>
              <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                data-drawer-hide="nav-and-sidebar" data-drawer-target="nav-and-sidebar" href="#"
