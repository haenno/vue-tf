...
<template>
  <header>
    <nav class="fixed top-0 left-0 z-50 w-14 h-14">
      <button data-drawer-target="nav-and-sidebar" data-drawer-toggle="nav-and-sidebar" aria-controls="nav-and-sidebar"
        type="button"
      ...
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <div class="flex justify-end items-center sm:w-64 absolute right-0 px-3 py-3">
          <div class="flex-auto me-3">
            <div class="flex ml-2">
              <img src="./assets/profilepic.jpg" class="h-11 mr-3 rounded-full" alt="haenno profile picture" />
              <span
        ...
        <div class="absolute top-20 w-56">
          <ul class="space-y-2 font-medium">
            ...
            <li>
              <a href="#" @click="userAuthStore.logout"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg
                  class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
