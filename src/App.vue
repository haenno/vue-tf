        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
              type="button" class="inline-flex items-center p-2 text-sm rounded-lg sm:hidden focus:outline-none focus:ring-2
          ...
          <div class="flex items-center">
            <div class="flex items-center ml-3">
              ...
              <div class="flex text-sm rounded-full focus:ring-4  me-2
                 bg-gray-200  dark:bg-gray-700
                  focus:ring-gray-300 dark:focus:ring-gray-600">
                <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400
              ...
              <div>
                <button type="button"
                  ...
                  <img class="w-8 h-8 rounded-full" src="./assets/profilepic.jpg" alt="user photo" />
                </button>
              </div>
              <div
